**Recognizance'22 Round 2** is a dataset for instance segmentation, object detection, instance segmentation, and classification tasks. It is used in the biological research. 
